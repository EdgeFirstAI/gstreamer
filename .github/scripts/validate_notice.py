...
# Known packages with correct licenses that scancode may fail to detect
KNOWN_ATTRIBUTION_PACKAGES: Set[str] = {
    # Add packages here if scancode misdetects their licenses
}
...
def get_first_level_dependencies(sbom: Dict) -> Set[str]:
    ...
    # If no dependency graph found, skip validation
